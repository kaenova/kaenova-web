...
function Section2Home() {
  ...
  const WhatIDoItem = ({ nama, isSelected, onClick }) => {
    return (
      <>
        <button onClick={onClick} className="relative flex flex-col justify-center items-center">
          {isSelected ? (
            <>
              <motion.p className="text-[14px] font-bold z-[1]"
  ...
  return (
    <>
      ...
      <section
        id="idx_sec2"
        className="h-full relative flex flex-col justify-center items-center pl-[50px] pr-[50px]"
      >
        ...
        <div className=" mt-[24px] ">
          ...
          <div className="hidden sm:block">
            <AnimateSharedLayout>
              <div className="w-[772px] h-[42px] bg-white shadow-md rounded-[7px] flex flex-row justify-between pl-[20px] pr-[20px] items-center">
                {whatIDoVerb.map((v) => (
                  <WhatIDoItem
                    key={v}
                    nama={v}
                ...
                {/* <button className="text-[14px] font-bold block_what_i_do">
                  Frontend
                </button>
                <button className="text-[14px] font-bold block_what_i_do">
                  Backend
        ...
        <div className="sm:grid sm:grid-cols-2 sm:gap-[75px] sm:items-center">
          <div className="hidden sm:block sm:bg-red-500">
            {" "}
            {/* Ini Bagian Kanan */}
          ...
          <div className="max-w-[420px]">
            ...
            <p className="tracking-normal text-justify">
              ...
              inventore corrupti earum nisi totam labore consequuntur expedita
              voluptatum eaque natus vitae nemo nulla at voluptate quis,
              adipisci facilis, repellat ducimus? Ini maksimal
            </p>
            <div className="mt-[20px] flex flex-col gap-3 justify-center items-center sm:text-left sm:items-start">
              ...
              <a className="underline tracking-normal" href="">
                Project 1
              </a>
              <a className="underline tracking-normal" href="">
                Project 2
